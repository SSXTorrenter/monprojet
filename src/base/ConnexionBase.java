...
/**
 * 634.1-Programmation / Classe issue de la correction contrôle continu du 02.04.2015
 * 
...
public class ConnexionBase {
  ...
  private static final String NOM_BASE = "GestionAct"; /* Nom de la base de données */
